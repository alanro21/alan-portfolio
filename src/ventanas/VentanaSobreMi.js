        ...
        <div className={`ventana ${isMobile ? "mobile" : "desktop"}`}>
            <div className={`ventana-sobre-mi ${estado}`}>
                <div className='barra-ventana'>
                    <img src={iconosobremi} className='icono-ventana-sobre-mi' alt='icono sobre mi'/>
               ...
               <div className='contenido-ventana'>
                   <div className='contenido-flex'>
                      ...
                      <div className='texto-sobre-mi'>
                          <p> Hola, me llamo Alan Hernan Rodríguez Agostini, tengo 24 años 
                            y soy estudiante de la carrera Licenciatura en Informática.</p>
                          <p>Me apasiona la programación como una herramienta para resolver problemas reales y 
                            transformar ideas en soluciones claras y funcionales. Este portafolio refleja mi proceso de aprendizaje, 
                            mi evolución técnica y los proyectos desarrollados tanto en la carrera como de forma autodidacta.</p>
                          <p>En cada proyecto busco trabajar con buenas prácticas, código limpio, 
                            lógica estructurada y una mentalidad orientada a la mejora continua. Me interesa seguir creciendo a nivel técnico y personal, enfrentar nuevos desafíos y 
                            aportar valor dentro de un equipo de trabajo.</p>
                      </div>
                    </div>
                </div>
